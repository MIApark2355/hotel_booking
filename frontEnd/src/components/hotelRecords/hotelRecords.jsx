//This goes to front page

import React, { useEffect, useState } from "react";
import { Link } from "react-router-dom";
import HotelItem from "../../components/hotelItem/HotelItem";
import "./hotelRecords.css"
// const Record = (props) => (
//     <tr>
...
//       <td>{props.record.ratings}</td>
//       {/* <td>
//         <Link className="btn btn-link" to={`/`/*`/edit/${props.record._id}`}>Book</Link> |
//       </td> */}
//     </tr>
//    );
const Record = (props) => (
...
<div className="all">
  ...
  <h1 className="listHeading">Hotel List</h1>
  </div>
